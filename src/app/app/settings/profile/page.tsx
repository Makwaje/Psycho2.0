    ...
    <div className=' flex gap-28 '>
      ...
      <div className='mt-24 flex flex-col gap-6'>
        ...
        <div>
          ...
          <Input className='w-[35rem]' type="email" id="fullname" placeholder="Name" />
        </div>
        <div>
          <Label htmlFor="name">Birthday</Label>
          <Input className='w-[35rem]' type="date" id="Birthday" placeholder="birthday" />
        </div>
        <div>
          <Label htmlFor="name">Email Address</Label>
          <Input className='w-[35rem]' type="email" id="email" placeholder="Email" />
        </div>
        <div>
          <Label htmlFor="name">Phone Number</Label>
          <Input className='w-[35rem]' type="number" id="phonenumber" placeholder="Phone Number" />
        </div>
        <div>
