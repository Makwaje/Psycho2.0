...
import { Message, loggedInUserData } from '@/lib/messages-data';
      ...
      <AnimatePresence initial={false}>
        ...
        >
          <Textarea
            ...
            name="message"
            placeholder="Aa"
            className="flex h-11 min-h-4 w-full resize-none items-center overflow-hidden rounded-full border bg-background"
          />
